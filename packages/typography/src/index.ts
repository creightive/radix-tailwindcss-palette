...
const colorNames = Object.keys(colors).filter(color => !color.includes("Dark"));
        ...
        for (let i = 0; i < colorNames.length; i++) {
          ...
          config[color] = {
            css: {
              ...
              "--tw-prose-invert-counters": theme(`colors.${color}.10`),
              "--tw-prose-invert-bullets": theme(`colors.${color}.8`),
              "--tw-prose-invert-hr": theme(`colors.${color}.6`),
              "--tw-prose-invert-quotes": theme(`colors.${color}.11`),
              ...
              "--tw-prose-invert-pre-bg": theme(`colors.${color}.2`),
              "--tw-prose-invert-th-borders": theme(`colors.${color}.6`),
